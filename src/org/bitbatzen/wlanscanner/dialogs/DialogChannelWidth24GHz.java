...
public class DialogChannelWidth24GHz 
		extends Dialog 
	...
	public DialogChannelWidth24GHz(MainActivity mainActivity) {
		super(mainActivity);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_channel_width24ghz);
		...
		radioButtonToOption.put(rb2.getId(), Util.CHANNEL_WIDTH_OPTION_22_MHZ);
		
		RadioButton rb3 = (RadioButton) findViewById(R.id.rb_dialog_channelwidth_3);
		rb3.setOnClickListener(this);
		radioButtonToOption.put(rb3.getId(), Util.CHANNEL_WIDTH_OPTION_40_MHZ);

		setCheckedRadioButton(mainActivity.getSelectedChannelWidth24GHz());
	}
	...
	public void onClick(View v) {
    	if (v.getId() == R.id.button_dialog_ok) {
        	...
        	mainActivity.setSelectedChannelWidth24GHz(selectedOption);
